                        ...
                        <div id="nav-menu"
                            ...
                            <div className="flex flex-col lg:flex-row lg:absolute lg:left-1/2 lg:-translate-x-1/2 items-start lg:items-center gap-6 lg:gap-8 w-full lg:w-auto">
                                <div className="nav-item mobile-stagger will-change-transform w-full lg:w-auto">
                                    <a href="#modules"
                                        className="text-slate-400 hover:text-white font-medium text-[16px] lg:text-[14px] transition-colors block py-2 lg:py-0">Modules</a>
                                </div>
                                ...
                                <div className="nav-item mobile-stagger will-change-transform w-full lg:w-auto">
                                    <a href="#pricing"
                                        className="text-slate-400 hover:text-white font-medium text-[16px] lg:text-[14px] transition-colors block py-2 lg:py-0">Pricing</a>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <a href="#login"
                                    className="mobile-stagger text-white font-medium text-[16px] lg:text-[14px] will-change-transform w-full lg:w-auto text-left py-2 lg:py-0 hover:text-slate-300 transition-colors">Client Login</a>
                                <a href="#demo"
